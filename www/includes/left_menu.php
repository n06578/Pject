...
<li class="nav-item <?=$activeMainYn?>">
    <a class="nav-link  <?=$activeSubYn?>" href="#" data-toggle="collapse" data-target="#collapsePro"
    ...
    <div id="collapsePro" class="collapse <?=$activeShow?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        ...
        ?>
                <a class="collapse-item <?=$_SESSION['left_menu_active'] == $row['projectSite'] ? "active":""?>" href="calc.php"><?if($row['projectIcon'] !=""){?><i class="<?=$row['projectIcon']?>"></i> <?}?><?=$row['projectName']?></i></a>
        <?
            }
        ?>
        </div>
...
?>
<li class="nav-item <?=$activeMainYn?>">
    <a class="nav-link <?=$activeSubYn?>" href="#" data-toggle="collapse" data-target="#collapseTwo"
    ...
    <div id="collapseTwo" class="collapse <?=$activeShow?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Custom Components:</h6>
            <a class="collapse-item <?=$_SESSION['left_menu_active'] == "buttons" ? "active":""?>" href="buttons.php">Buttons</a>
            <a class="collapse-item <?=$_SESSION['left_menu_active'] == "cards" ? "active":""?>" href="cards.php">Cards</a>
        </div>
    </div>
</li>
...
?>
<li class="nav-item <?=$activeMainYn?>">
    <a class="nav-link  <?=$activeSubYn?>" href="#" data-toggle="collapse" data-target="#collapseUtilities"
    ...
    <div id="collapseUtilities" class="collapse <?=$activeShow?>" aria-labelledby="headingUtilities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?=$_SESSION['left_menu_active'] == "utilities-color" ? "active":""?>" href="utilities-color.php">Colors</a>
            <a class="collapse-item <?=$_SESSION['left_menu_active'] == "utilities-border" ? "active":""?>" href="utilities-border.php">Borders</a>
            <a class="collapse-item <?=$_SESSION['left_menu_active'] == "utilities-animation" ? "active":""?>" href="utilities-animation.php">Animations</a>
            <a class="collapse-item <?=$_SESSION['left_menu_active'] == "utilities-other" ? "active":""?>" href="utilities-other.php">Other</a>
        </div>
    </div>
</li>
...
?>
<li class="nav-item <?=$activeMainYn?>">
    <a class="nav-link <?=$activeSubYn?>" href="#" data-toggle="collapse" data-target="#collapsePages"
    ...
    <div id="collapsePages" class="collapse <?=$activeShow?>" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?=$_SESSION['left_menu_active'] == "login" ? "active":""?>" href="login.php">Login</a>
            <a class="collapse-item <?=$_SESSION['left_menu_active'] == "register" ? "active":""?>" href="register.php">Register</a>
            <a class="collapse-item <?=$_SESSION['left_menu_active'] == "forgot-password" ? "active":""?>" href="forgot-password.php">Forgot Password</a>
            <div class="collapse-divider"></div>
            <h6 class="collapse-header">Other Pages:</h6>
            <a class="collapse-item <?=$_SESSION['left_menu_active'] == "404" ? "active":""?>" href="404.php">404 Page</a>
            <a class="collapse-item <?=$_SESSION['left_menu_active'] == "blank" ? "active":""?>" href="blank.php">Blank Page</a>
        </div>
    </div>
</li>
