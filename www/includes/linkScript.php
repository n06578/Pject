    ...
    <link href="https://cdn.jsdelivr.net/npm/@pnotify/confirm@5.2.0/dist/PNotifyConfirm.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/@pnotify/core@5.2.0/dist/BrightTheme.min.css" rel="stylesheet">

    <!-- JavaScript -->
    <script src="https://cdn.jsdelivr.net/npm/@pnotify/core@5.2.0/dist/PNotify.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/@pnotify/confirm@5.2.0/dist/PNotifyConfirm.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/@pnotify/mobile@5.2.0/dist/PNotifyMobile.js"></script>
    <script src="<?=$rootPath?>js/PNotify.js"></script>
    <!-- PNotify 부분 시작 -->
