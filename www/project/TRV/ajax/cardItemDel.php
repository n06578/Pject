...
switch($_REQUEST['pageType']){
    ...
    case "heart":
        ...
        break;
    case "cal":
        $que = "select * from TcalanItemTbl where joinSeq='".$_SESSION['loginNum']."' and itemSeq in (".implode(",",$_REQUEST['chkData']).")";
        $que_back = "insert into TcalanItemDelTbl $que";
        $que_del = "delete from TcalanItemTbl where joinSeq='".$_SESSION['loginNum']."' and itemSeq in (".implode(",",$_REQUEST['chkData']).")";
    break;
    default: $que="";break;
}
if($que == ""){
